<div class="container">
  ...
  <?php } ?>
    ...
    <?php if( count($lite) > 0){ ?>
        <section class="row" id="my-reports-lite">
            <div class="col">

                <h1>I Miei Report (Light)</h1>
                ...
                >
                    ...
                    <tbody>
                    <?php foreach($lite as $r){ ?>
                        <tr>
                            <td>
                                <?php
                                echo ($r->status == 7) ? '<a href="/lite/view/' . $r->idreport_lite . '">' . $r->titolo . '</a>' : $r->titolo;
                                ?>
                            </td>
                            <?php if($Profile->role < 3){ ?>
                                <td><a href="mailto:<?php echo $r->email; ?>"><?php echo $r->username; ?></a></td>
